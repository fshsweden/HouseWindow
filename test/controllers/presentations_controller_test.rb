...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { prez1: @presentation.prez1, prez2: @presentation.prez2, shorttext: @presentation.shorttext, title: @presentation.title, user_id: @presentation.user_id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { prez1: @presentation.prez1, prez2: @presentation.prez2, shorttext: @presentation.shorttext, title: @presentation.title, user_id: @presentation.user_id } }
